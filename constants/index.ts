...
// The hardcoded `quarterlyTiers` + `teamRankings` mock arrays used to live here. They fed the
// /home "Rankings and Tiers" card with a frozen snapshot of a past quarter, so the home page
// could never reflect real results (owner backlog #9 / #20, 2026-08-03). That card now reads the
// live public API via app/(user)/_components/HomeRankingsTiers.tsx:
...
// Do not reintroduce static standings here; add a field to the serializer instead.
