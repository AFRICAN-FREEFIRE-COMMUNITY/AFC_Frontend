...
export default function TeamDetailPage() {
  ...
  const handleBanTeam = async () => {
    try {
      ...
      const banReasonString = banReasons
        ...
        .join(", ")
      setTeamData((prevData) => ({ ...prevData, isBanned: true, banReason: banReasonString })) // Update ban status and reason
  ...
  const handleUnbanTeam = async () => {
    try {
      ...
      setTeamData((prevData) => ({ ...prevData, isBanned: false, banReason: "" }))
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <AlertDialog open={banModalOpen} onOpenChange={setBanModalOpen}>
            <AlertDialogTrigger asChild>
              <Button variant={teamData.isBanned ? "secondary" : "destructive"}>
                {teamData.isBanned ? "Unban" : "Ban"}
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>{teamData.isBanned ? "Unban Team" : "Ban Team"}</AlertDialogTitle>
                <AlertDialogDescription>
                  {teamData.isBanned
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction onClick={teamData.isBanned ? handleUnbanTeam : handleBanTeam}>
                  {teamData.isBanned ? "Unban" : "Ban"}
                </AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <p>
                  <strong>Total Earnings:</strong> {teamData.totalEarnings}
                </p>
                <p>
                  <strong>Average Kills:</strong> {teamData.averageKills}
                </p>
                <p>
                  <strong>Average Placement:</strong> {teamData.averagePlacement}
                </p>
                <div>
                  <p>
                ...
                {teamData.isBanned && (
                  <p>
                    <strong>Ban Reason:</strong> {teamData.banReason}
                  </p>
                )}
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {teamData.tournamentPerformance.map((tournament, index) => (
                    <TableRow key={index}>
