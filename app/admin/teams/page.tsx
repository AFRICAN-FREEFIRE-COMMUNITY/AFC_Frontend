...
const AdminTeamsPage = () => {
  ...
  const [teams, setTeams] = useState([]) // Added state variable
  ...
  const handleBanTeam = async () => {
    try {
      ...
      toast({
        title: "Team Banned",
        description: `Successfully banned ${selectedTeam.name} from ${banDateRange.from.toLocaleDateString()} to ${banDateRange.to.toLocaleDateString()}.`,
      })
    } catch (error) {
      toast({
        title: "Error",
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <AlertDialog open={banModalOpen} onOpenChange={setBanModalOpen}>
                          <AlertDialogTrigger asChild>
                            <Button
                              variant={team.isBanned ? "secondary" : "destructive"}
                              onClick={() => {
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>{selectedTeam?.isBanned ? "Unban Team" : "Ban Team"}</AlertDialogTitle>
                              <AlertDialogDescription>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction
                                onClick={
                                  selectedTeam?.isBanned ? () => handleUnbanTeam(selectedTeam.id) : handleBanTeam
                                }
                              >
