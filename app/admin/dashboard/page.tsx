...
const fetchRecentActivities = async () => {
  ...
  return [
    { id: 1, user: "John Doe", action: "Updated tournament results", timestamp: "2023-07-01 14:30" },
    { id: 2, user: "Jane Smith", action: "Created new announcement", timestamp: "2023-07-01 13:15" },
    { id: 3, user: "Mike Johnson", action: "Banned player #12345", timestamp: "2023-07-01 11:45" },
  ]
}
