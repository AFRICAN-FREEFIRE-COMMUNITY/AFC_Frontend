...
export default function page() {
      ...
      <div className="flex min-h-screen w-full flex-col items-center justify-center">
        <Card className="w-full max-w-md mx-auto">
          <CardContent className="text-center p-8">
            ...
            <h2 className="text-xl font-semibold mb-2">Error Loading Awards</h2>
      ...
      <div className="flex min-h-screen w-full flex-col items-center justify-center p-4">
        <Card className="w-full max-w-4xl mx-auto">
          <CardContent className="text-center p-6 md:p-8">
            <CheckCircle2 className="h-16 w-16 md:h-24 md:w-24 text-green-500 mx-auto mb-4 md:mb-6" />
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-base md:text-lg flex items-center justify-center">
                    <Trophy className="h-4 w-4 md:h-5 md:w-5 mr-2 text-primary" />
  ...
  return (
    <div className="flex min-h-screen w-full flex-col relative overflow-hidden">
      {/* Header */}
      <div className="relative rounded-md bg-gradient-to-r from-primary/20 via-primary/10 to-primary/20 border-b">
        <div className="absolute rounded-md inset-0 bg-[url('/placeholder.svg?height=200&width=1200&text=Awards+Background')] opacity-10"></div>
        <div className="relative container mx-auto px-4 py-8 md:py-12 text-center">
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto mb-3 md:mb-4 px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm text-muted-foreground">
            ...
            <div className="flex items-center">
              <Trophy className="h-3 w-3 sm:h-4 sm:w-4 mr-1 text-primary" />
      ...
      <main className="flex flex-1 flex-col gap-4 md:gap-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          {awardsData.map((section) => {
            const tabId = getSectionTabId(section.name);
            return (
              <TabsContent key={section.id} value={tabId} className="">
                ...
                <div className="grid gap-2 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 auto-rows-fr">
                  {section.categories.map((category) => {
                    ...
                    return (
                      <Card
                        key={category.id}
                        className="hover:shadow-lg gap-0 transition-shadow duration-200 flex flex-col h-full"
                      >
                        <CardHeader className="pb-3 md:pb-4 flex-shrink-0">
                          <div className="flex items-start justify-between gap-2">
                            <CardTitle className="text-sm sm:text-base md:text-lg flex items-start flex-1 min-w-0">
                              <Award className="h-4 w-4 md:h-5 md:w-5 mr-2 text-primary flex-shrink-0 mt-0.5" />
                        ...
                        <CardContent className="space-y-2 md:space-y-3 flex-1 flex flex-col pt-0">
                                ...
                                >
                                  <div className="flex flex-col flex-1 min-w-0">
                                    <div className="flex items-center gap-1.5 md:gap-2">
                                      <span className="font-medium text-foreground text-xs sm:text-sm break-words leading-tight">
                                        {nominee.name}
                                      </span>
                                      {isVoted && (
                                    ...
                                    {nominee.videoUrl && (
                                      <Link
                                        ...
                                        className="mt-1 md:mt-1.5 text-[10px] sm:text-xs text-blue-500 hover:text-blue-600 hover:underline flex items-center gap-1 transition-colors duration-200 w-fit"
                                      >
                                        <PlayCircle className="h-3 w-3 md:h-3.5 md:w-3.5 flex-shrink-0" />
