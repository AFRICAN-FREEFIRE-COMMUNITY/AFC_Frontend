...
//     const response = await fetch(
//       `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/events/get-event-details/`,
//       {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           // Note: Server-side SEO usually doesn't have access to client-side 'token'
//           // unless it's stored in cookies.
//         },
//         body: JSON.stringify({ event_id: id }),
//       },
//     );
...
//     return {
//       title: `${event.event_name} | Your Platform Name`,
//       description: event.description || "Join us for this amazing event!",
//       openGraph: {
//         title: event.event_name,
//         description: event.description,
//         images: [event.banner_image || "/default-event-image.jpg"],
//         type: "website",
//       },
//       twitter: {
...
//     return {
//       title: "Event Details",
//       description: "View event details and stages.",
//     };
//   }
// }
