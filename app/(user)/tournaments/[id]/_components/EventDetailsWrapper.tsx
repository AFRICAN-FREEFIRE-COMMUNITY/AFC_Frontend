...
// // //     return userTeam?.members.filter((m) => selectedMembers.includes(m.id)) || [];
...
// // //               </div>
// // //               <div>
// // //                 <span className="font-semibold text-primary">Members Selected:</span>{" "}
...
// // //         setUserTeam(resCurrent.data.team);
// // //       } else {
...
// //             <div className="p-4 bg-primary/10 rounded-md">
// //               <h3 className="font-medium mb-3 text-sm">Available Players:</h3>
// //               <div className="space-y-2 max-h-80 overflow-y-auto">
// //                 {userTeam?.members.map((member) => (
// //                   <div
// //                     key={member.id}
...
// //             <div className="p-4 bg-primary/10 text-sm rounded-md space-y-3">
// //               <div>
...
// //               </div>
// //               <div>
// //                 <span className="font-medium text-primary">Tournament:</span>{" "}
// //                 {eventDetails.event_name}
// //               </div>
// //               <div>
...
// //               <div>
// //                 <p className="font-medium text-primary mb-2">Team Members:</p>
// //                 <ul className="space-y-1">
// //                   {selectedMembersData.map((member, idx) => (
// //                     <li key={member.id} className="text-sm">
// //                       {idx + 1}. {member.username}
...
// //           <>
// //             <DialogHeader>
// //               <DialogTitle>Tournament Rules & Policies</DialogTitle>
// //             </DialogHeader>
// //             <div className="max-h-80 p-4 bg-primary/10 rounded-md overflow-y-auto pr-4 space-y-4 text-sm text-muted-foreground">
// //               {renderRulesContent()}
...
// //           <>
// //             <DialogHeader>
// //               <DialogTitle>Join AFC Discord Server</DialogTitle>
// //               <DialogDescription>Final step for registration</DialogDescription>
// //             </DialogHeader>
// //             <div className="text-center p-4 bg-primary/10 rounded-lg space-y-4">
// //               <p className="text-sm text-gray-300">
...
// //   const handleTeamContinueToRules = () => {
// //     setTeamModalStep("CLOSED");
// //     setModalStep("RULES");
// //   };
...
// interface ModalProps {
//   eventDetails: EventDetails & { selectedTeamMembers?: TeamMember[] };
//   modalStep: ModalStep;
//   setModalStep: (step: ModalStep) => void;
//   handleSelectType: (type: RegistrationType) => void;
//   rulesAccepted: boolean;
...
//       case "DISCORD_STATUS":
//         const allMembersConnected =
//           eventDetails.selectedTeamMembers?.every((m) => m.discord_connected) ??
//           false;
...
//             <div className="p-4 bg-primary/10 rounded-md space-y-4">
//               <div className="space-y-2">
//                 <h3 className="font-semibold text-sm">
//                   Team Members Discord Status:
//                 </h3>
//                 <div className="space-y-2">
//                   {eventDetails.selectedTeamMembers?.map(
//                     (member: TeamMember) => (
//                       <div
//                         key={member.id}
...
//                     All team members have connected Discord! You can proceed.
//                   </p>
//                 </div>
//               )}
