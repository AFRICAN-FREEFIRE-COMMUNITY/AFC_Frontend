...
const newsItems = [
  ...
  },
  {
    ...
    excerpt: "Exciting new character and weapon skins are now available in the shop. Limited time offer!",
    date: "2023-06-25",
  },
]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 mb-8">
          <Card className="card-hover">
            ...
            <CardContent>
              <p className="text-4xl font-bold gold-text">15,789</p>
            </CardContent>
          </Card>
          <Card className="card-hover">
            <CardHeader>
            ...
            <CardContent>
              <p className="text-4xl font-bold gold-text">5,234</p>
            </CardContent>
          </Card>
          <Card className="card-hover">
            <CardHeader>
            ...
            <CardContent>
              <p className="text-4xl font-bold gold-text">12</p>
            </CardContent>
          </Card>
          <Card className="card-hover">
            <CardHeader>
            ...
            <CardContent>
              <p className="text-4xl font-bold gold-text">$250,000</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-8">
              ...
              <ul className="space-y-4">
                {newsItems.map((item) => (
                  <li key={item.id} className="border-b pb-4 last:border-b-0 last:pb-0">
                    ...
                    <p className="text-sm text-muted-foreground mb-1">{item.excerpt}</p>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-4">
                {shopItems.map((item) => (
                  <li key={item.id} className="flex items-center space-x-4 border-b pb-4 last:border-b-0 last:pb-0">
                    <Image
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-sm text-muted-foreground">{item.price} Diamonds</p>
                    </div>
