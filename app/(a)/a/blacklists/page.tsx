...
// PageHeader, Select filter, shadcn Table, the shared Pagination component, sonner
// toasts, FullLoader on first load only. StatCard mirrors app/(a)/a/rankings/page.tsx.
