...
//           maps: [], // Initialize with empty maps array
//         }))
//       );
//     }
...
//     );
//     if (invalidGroup) {
//       toast.error("Please complete all group details correctly, including selecting at least one map per group");
//       return;
//     }
...
import { Trash2, ChevronUp, ChevronDown, Upload, X } from "lucide-react";
import { useRouter } from "next/navigation";
import { PageHeader } from "@/components/PageHeader";
import { useAuth } from "@/contexts/AuthContext";
import { env } from "@/lib/env";
        ...
        <Form {...form}>
          ...
          <Dialog open={isStageModalOpen} onOpenChange={setIsStageModalOpen}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              {/* MODAL STEP 2: Groups Configuration WITH MAP SELECTION */}
              {stageModalStep === 2 && (
                <div className="space-y-3">
                  <div className="bg-primary/10 border rounded-md p-4">
                    <p className="text-sm">
