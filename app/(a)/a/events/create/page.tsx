  ...
  const onSubmit = (data: EventFormType) => {
    startTransition(async () => {
      try {
        ...
        // } else {
        //   // --- USE PURE JSON APPROACH (NO FILES) ---
        //   console.log("yesss");
        //   const jsonPayload = {
        ...
        //     max_teams_or_players: data.max_teams_or_players,
        ...
        //     upload_rules: data.rules_document,
        //     publish_to_tournaments: data.publish_to_tournaments,
        //     publish_to_news: data.publish_to_news,
        //     save_to_drafts: data.save_to_drafts,
        //     stream_channels:
        //       data.stream_channels?.filter((s) => s.trim() !== "") || [],
        //     stages: data.stages,
        //   };
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            ...
                            onChange={(e) => {
                              field.onChange(e);
                              handleStageCountChange(Number(e.target.value));
                            }}
                            className=""
                          />
                        </FormControl>
