  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-green-600 flex-1 hover:bg-green-700 text-white">
        ...
        <div className="space-y-6 mt-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full border border-gray-600 text-black rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
            >
          ...
          <div>
            ...
            <select
              ...
              className="w-full border border-gray-600 rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-black"
            >
