  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="line-clamp-1">Esports Award Votes</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="grid gap-2 md:grid-cols-2">
                {allSectionsData.length === 0 ? (
                  ...
                  allSectionsData.map((section) => {
                    ...
                    const totalVotes = sectionCategories.reduce((sum, cat) => {
                ...
                {(() => {
                  ...
                  return sortedCategories.map((category, index) => (
                    <div
                      ...
                      className="space-y-2"
                    >
                      <div className="flex flex-col md:flex-row  items-start md:items-center justify-start gap-2 md:justify-between">
                        <div className="flex items-center line-clamp-1 flex-1">
              ...
              {(() => {
                ...
                const winnersBySection = allWinners.reduce((acc, winner) => {
                  ...
                  const category = allCategoriesData.find(
                    (c) => String(c.id || c._id) === String(winner.category_id)
                  );
                                  ...
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                        ...
                                        <span>•</span>
                                        <span>
                                          {winner.winning_percentage.toFixed(1)}
                                          %
                                        </span>
                                      </div>
                                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="all">All Sections</SelectItem>
                            {getUniqueSectionsFromNominees().map((section) => (
                      ...
                      <div>
                        ...
                        <div className="h-10 flex items-center">
                          <Badge variant="secondary" className="text-sm">
                            {getFilteredNominees().length} of {nominees.length}{" "}
                            nominees
                          </Badge>
                        </div>
                      </div>
                                  ...
                                  <TableCell className="text-right">
                                    <div className="flex justify-end gap-2">
                                      ...
                                      <Button
                                        ...
                                        size="icon"
                                        onClick={() =>
                                          handleDeleteNominee(nom.id || nom._id)
                                        }
                                        disabled={
