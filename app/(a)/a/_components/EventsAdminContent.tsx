...
// EventsAdminContent
// ----------------------------------------------------------------------------
// The Events admin surface, extracted VERBATIM from the old standalone
// app/(a)/a/events/page.tsx so it can render as the "Events" tab of the combined
// Events & Leaderboards page (owner request 2026-06-09: merge the two admin pages
// into one tabbed page). Behaviour is unchanged: same stat counts + event list
// (GET /events/get-all-events/ and the count endpoints), the Event Payments +
// Create new event header buttons, search, and the per-row View/Edit/Delete
// actions.
//
// RENDERED BY: app/(a)/a/events/page.tsx (the combined page, Events tab). The
// event detail/edit/create/payments routes under /a/events/* are separate pages
// and are unaffected. EventProp is exported here because the Leaderboards surface
// (LeaderboardsAdminContent) imports it.
// ─────────────────────────────────────────────────────────────────────────────
...
export const EventsAdminContent = () => {
