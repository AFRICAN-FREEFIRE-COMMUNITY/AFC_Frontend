...
// //   // Fetch categories and nominees on component mount
// //   useEffect(() => {
// //     fetchInitialData();
// //   }, []);
...
// //         setStats((prev) => ({
// //           ...prev,
// //           totalCategories: (data.categories || data || []).length,
// //         }));
// //       }
// //     } catch (error) {
...
// //       if (response.ok) {
// //         const data = await response.json();
// //         setNominees(data.nominees || data || []);
// //         setStats((prev) => ({
// //           ...prev,
// //           totalNominees: (data.nominees || data || []).length,
// //         }));
// //       }
// //     } catch (error) {
...
// //     try {
// //       const response = await fetch(`${env.NEXT_PUBLIC_BACKEND_API_URL}/awards/nominees/add/`, {
// //         method: "POST",
// //         headers: {
// //           "Content-Type": "application/json",
// //         },
...
// //         await fetchNominees(); // Refresh nominees list
// //       } else {
// //         setMessage({
// //           type: "error",
...
// //                 Assign nominees to award categories
// //               </p>
// //             </div>
...
// //               <div className="bg-primary/10 border rounded-lg p-6">
...
// //             {/* Form Card */}
// //             <div className="bg-primary/10 border rounded-lg p-8">
// //               <div className="flex items-center mb-6">
// //                 <Award className="w-6 h-6 text-green-500 mr-3" />
// //                 <h2 className="text-2xl font-bold">Nominee Assignment Form</h2>
// //               </div>
...
// //                         <span className="text-white font-medium">
// //                           {
// //                             nominees.find((n) => n.id === formData.nominee_id)
// //                               ?.name
// //                           }
// //                         </span>
// //                       </div>
...
// //             {/* Help Section */}
// //             <div className="mt-8 bg-primary/10 border rounded-lg p-6">
...
// //                   <span>
// //                     Ensure the nominee meets the eligibility criteria for the
// //                     selected category
// //                   </span>
// //                 </li>
// //                 <li className="flex items-start">
// //                   <span className="text-green-500 mr-2">•</span>
// //                   <span>A nominee can be assigned to multiple categories</span>
// //                 </li>
// //                 <li className="flex items-start">
// //                   <span className="text-green-500 mr-2">•</span>
// //                   <span>
// //                     Duplicate assignments will be prevented by the system
// //                   </span>
// //                 </li>
// //                 <li className="flex items-start">
// //                   <span className="text-green-500 mr-2">•</span>
// //                   <span>
// //                     You can manage or remove nominees from the "View All
// //                     Nominees" section
// //                   </span>
// //                 </li>
// //               </ul>
...
//             <p className="text-gray-400">
//               Create nominees and assign them to award categories
//             </p>
//           </div>
//           <div className="text-right text-sm text-gray-400">
//             Last updated: {new Date().toLocaleString()}
...
//             <div className="flex items-center mb-6">
//               <Award className="w-6 h-6 text-green-500 mr-3" />
//               <h2 className="text-2xl font-bold">Assign Nominee to Category</h2>
//             </div>
...
//                 <span className="text-green-500 mr-2">•</span>
//                 <span>
//                   Create new nominees first before assigning them to categories
//                 </span>
//               </li>
//               <li className="flex items-start">
//                 <span className="text-green-500 mr-2">•</span>
