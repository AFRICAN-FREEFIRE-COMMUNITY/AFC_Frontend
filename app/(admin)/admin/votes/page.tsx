...
//                         .toLowerCase();
//                       const categoryId =
//                         selectedCategoryData.id || selectedCategoryData._id;

//                       // Filter nominees by checking if they're assigned to this category
//                       // Since nomineeVotes doesn't have category info, we need to cross-reference with allNomineesData
//                       filteredNominees = nomineeVotes.filter((nomVote) => {
//                         // Find this nominee in the full nominees list
//                         const fullNomineeData = allNomineesData.find(
//                           (n) =>
//                             (n.id || n._id) ===
//                               (nomVote.nominee_id || nomVote.id) ||
//                             n.name?.trim().toLowerCase() ===
//                               nomVote.nominee_name?.trim().toLowerCase()
//                         );
...
//                         // Check if this nominee is assigned to the selected category
//                         const nomineeCategories =
//                           fullNomineeData.categories || [];

//                         return nomineeCategories.some((cat) => {
//                           // Match by ID
//                           if ((cat.id || cat._id) === categoryId) {
//                             return true;
//                           }
...
//                   const sortedNominees = nomineesWithVotes
//                     .filter((nom) => nom.percentage > 0) // Only show nominees with votes
