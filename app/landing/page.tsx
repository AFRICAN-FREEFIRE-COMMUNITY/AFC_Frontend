...
import { Trophy, Users, Calendar, Star, Target, Shield, Award, GamepadIcon, Crown, Flame } from "lucide-react"
  ...
  const features = [
    {
      ...
      description: "Join high-stakes tournaments with amazing prizes and recognition in the AFC community.",
    },
    {
      icon: Users,
      title: "Team Management",
      description: "Create and manage your esports team with advanced roster and strategy tools.",
    },
    {
      icon: Target,
      title: "Skill Rankings",
      description: "Track your progress with our comprehensive ranking system and leaderboards.",
    },
    {
      icon: Calendar,
      title: "Event Scheduling",
      description: "Never miss a match with our integrated calendar and notification system.",
    },
    {
      icon: Shield,
      title: "Fair Play",
      description: "Compete in a secure environment with anti-cheat measures and fair play policies.",
    },
    {
      icon: Award,
      title: "Achievements",
      description: "Unlock badges, titles, and rewards as you climb the competitive ladder.",
    },
  ]
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <Logo size="small" />
            <span className="text-xl font-bold bg-gradient-to-r from-primary to-[hsl(var(--gold))] bg-clip-text text-transparent">
              AFC Esports
            </span>
          </div>
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Join the ultimate Free Fire competitive platform. Compete in tournaments, climb rankings, and prove you're
              the best player in the AFC community.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-3xl font-bold text-[hsl(var(--gold))] mb-2">{stat.value}</div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Experience the most comprehensive Free Fire competitive platform with features designed for serious
              players.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of players competing for glory, prizes, and the ultimate bragging rights in Free Fire.
            </p>
      ...
      <footer className="border-t border-border/40 bg-background/50 backdrop-blur-sm mt-12">
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <Logo size="small" />
                <span className="text-lg font-bold text-primary">AFC Esports</span>
              </div>
          ...
          <div className="border-t border-border/40 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">© 2024 AFC Esports. All rights reserved.</p>
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <span className="text-sm text-muted-foreground">Powered by AFC Gaming</span>
            </div>
          </div>
        </div>
      </footer>
